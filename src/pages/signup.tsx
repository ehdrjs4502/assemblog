...
export default function signup() {
    ...
    const handleSubmit = (e: FormEvent) => { // 회원가입 버튼 클릭 했을 때 함수
        e.preventDefault();
        ...
        } else if(username === '') { // 닉네임 인풋창에 값이 없으면
    ...
    return (
        <div>
            ...
            <Stack
                ...
                <TextField id="outlined-basic" label="User Name" variant="outlined" type="text" size="small" error={!usernameCheck} helperText={usernameCheck ? "" : "유저 네임을 입력해주세요"} onChange={(e) => {setUsername(e.target.value); setUsernameCheck(true)}} inputRef={userNameRef}/>
